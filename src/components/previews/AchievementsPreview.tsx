  ...
  return (
    <section className="py-16 px-4 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {topAchievements.map((achievement, index) => (
            <motion.div
              ...
              className="bg-neutral-900/50 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all duration-300 hover:transform hover:scale-105 group"
            >
              {/* Icon and Title */}
              <div className="flex items-center mb-4">
                <div className={`p-3 rounded-xl ${achievement.color} mr-4`}>
                  {achievement.icon}
                </div>
                <div>
              ...
              {achievement.imageFile && (
                <div className="mb-4">
                  <div className="w-full h-32 bg-white/5 border border-white/10 rounded-lg overflow-hidden group-hover:border-white/20 transition-colors">
                    <img
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex flex-wrap gap-1">
                  {achievement.skills.slice(0, 3).map((skill, skillIndex) => (
                    <span
                      key={skillIndex}
                      className="px-2 py-1 bg-white/5 border border-white/10 rounded-full text-xs text-gray-400 hover:border-white/20 transition-colors"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              {/* Decorative Elements */}
              <div className="absolute -top-1 -right-1 w-16 h-16 bg-white/5 rounded-full blur-xl group-hover:bg-white/10 transition-opacity duration-500" />
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="text-center p-4 bg-neutral-900/30 backdrop-blur-sm border border-white/10 rounded-xl">
            <div className="flex items-center justify-center mb-2">
              <Target className="w-5 h-5 text-gray-400 mr-1" />
              <span className="text-2xl font-bold text-white">Top 15</span>
            </div>
            <p className="text-gray-500 text-xs">Out of 500</p>
          </div>
          ...
          <div className="text-center p-4 bg-neutral-900/30 backdrop-blur-sm border border-white/10 rounded-xl">
            ...
            <p className="text-gray-500 text-xs">Entrepreneurship</p>
          </div>
          
          <div className="text-center p-4 bg-neutral-900/30 backdrop-blur-sm border border-white/10 rounded-xl">
            <div className="flex items-center justify-center mb-2">
              <Award className="w-5 h-5 text-gray-400 mr-1" />
              <span className="text-2xl font-bold text-white">Global</span>
            </div>
            <p className="text-gray-500 text-xs">NASA Nominee</p>
          </div>
          ...
          <div className="text-center p-4 bg-neutral-900/30 backdrop-blur-sm border border-white/10 rounded-xl">
            ...
            <p className="text-gray-500 text-xs">Major Awards</p>
          </div>
        </motion.div>
